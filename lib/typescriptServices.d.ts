...
declare module ts {
    ...
    const enum ParsingContext {
        ...
        BlockStatements = 2,
        SwitchClauses = 3,
        SwitchClauseStatements = 4,
        TypeMembers = 5,
        ClassMembers = 6,
        EnumMembers = 7,
        BaseTypeReferences = 8,
        VariableDeclarations = 9,
        ArgumentExpressions = 10,
        ObjectLiteralMembers = 11,
        ArrayLiteralMembers = 12,
        Parameters = 13,
        TypeParameters = 14,
        TypeArguments = 15,
        TupleElementTypes = 16,
        Count = 17,
    }
...
declare module ts {
    ...
    var switchToForwardSlashesRegEx: RegExp;
